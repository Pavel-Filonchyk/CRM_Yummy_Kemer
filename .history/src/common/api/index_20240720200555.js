...
export const menuUrl = (index) => {
    return `https://online-store-19e86-default-rtdb.europe-west1.firebasedatabase.app/menu/${index}.json`
}
export const putDishes = (index) => {
    return `https://online-store-19e86-default-rtdb.europe-west1.firebasedatabase.app/menu/${index}/dishes.json`
}
